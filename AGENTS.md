...
- Naming: **ChristianClaw** product/docs brand (fork of OpenClaw); `openclaw` CLI/package/path/config retained for compatibility. Christian-values posture and default team live in `src/agents/christian-values.ts` and `examples/christian-team/`.
